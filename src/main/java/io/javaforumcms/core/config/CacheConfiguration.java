package io.javaforumcms.core.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("javaforum");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("javaforum");
        ...
        config.getMapConfigs().put("io.javaforumcms.core.domain.*", initializeDomainMapConfig(jHipsterProperties));
